...
console.log(areaRectangle(4, 6))
console.log(areaSquare(2, 4))
console.log(areaTriangle(6, 3))
console.log(areaParallelogram(5, 6))
console.log(areaTrapezium(5, 12, 10))
console.log(areaCircle(5))
console.log(areaRhombus(12, 10))
